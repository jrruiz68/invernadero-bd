...
CREATE TABLE IF NOT EXISTS `invernaderoBD`.`experimento` (
  ...
  UNIQUE INDEX `nombre_experimento_UNIQUE` (`nombre_experimento` ASC),
  INDEX `id_usuario_idx` (`usuario` ASC),
  INDEX `iddetalle_calibracion_idx` (`detalle_calibracion` ASC),
...
CREATE TABLE IF NOT EXISTS `invernaderoBD`.`fecha_de_sensado` (
  ...
  INDEX `id_experimento_idx` (`id_experimento` ASC),
...
CREATE TABLE IF NOT EXISTS `invernaderoBD`.`infiltrometro` (
  ...
  INDEX `id_fecha_idx` (`fecha_sensado` ASC),
  CONSTRAINT `id_fecha`
